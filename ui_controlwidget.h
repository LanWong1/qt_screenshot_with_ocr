...
public:
    ...
    void setupUi(QWidget *ControlWidget)
    {
        ...
        ocrBtn = new QToolButton(ControlWidget);
        ocrBtn->setObjectName("ocrBtn");
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/image/ocr.png"), QSize(), QIcon::Normal, QIcon::Off);
        ocrBtn->setIcon(icon8);
        ocrBtn->setIconSize(QSize(25, 25));
        ocrBtn->setAutoRaise(true);

        horizontalLayout->addWidget(ocrBtn);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/image/control_12.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        cancelBtn->setIcon(icon10);
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/image/control_13.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        finishBtn->setIcon(icon11);
