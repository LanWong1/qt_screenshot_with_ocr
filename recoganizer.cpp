#include "recoganizer.h"

Recoganizer::Recoganizer()
{
    string model_path = "ocr/weights/ch_PP-OCRv3_rec_infer.onnx";
    ...
    ifstream ifs("ocr/rec_word_dict.txt");
    string line;
...
Mat Recoganizer::preprocess(Mat srcimg)
{
    Mat dstimg;
    int h = srcimg.rows;
    int w = srcimg.cols;
...
void Recoganizer::normalize_(Mat img)
{
...
string Recoganizer::predict_text(Mat cv_image)
{
